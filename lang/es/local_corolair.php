...
$string['setupreadynotification'] = 'Corolair se instaló. Los servicios web de Moodle y REST ya están habilitados, por lo que no se necesita consentimiento para habilitarlos. Un administrador puede <a href="{$a}">iniciar el registro de Corolair</a>.';
...
$string['setuprequirednotification'] = 'Corolair está instalado, pero permanece inactivo. Un administrador del sitio debe <a href="{$a}">revisar y aprobar los cambios necesarios en los servicios web</a>.';
...
$string['setupstatusrequired'] = 'La configuración requiere el consentimiento de un administrador. {$a}';
$string['setupstatusready'] = 'Los servicios web y REST ya están habilitados. No se necesita consentimiento para habilitarlos; inicie el registro. {$a}';
