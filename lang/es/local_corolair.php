...
$string['apikeyset'] = 'La clave API ya está configurada; vuelva a cargar la página';
...
$string['disclosurecaproleassign'] = 'Permite asignar el rol Gestor de Raison a un formador invitado desde Corolair.';
...
$string['disclosuregrouproleassignmentdesc'] = 'Asignar el rol Gestor de Raison cuando se inicia una invitación autorizada desde Corolair.';
$string['disclosureheading'] = 'Revise la información de la integración Corolair';
...
$string['disclosuretokentransfer'] = 'El token se transfiere a Corolair mediante HTTPS para que la integración invoque las funciones permitidas de Moodle. Caduca a los 15 días y se rota antes de su vencimiento.';
$string['disclosureversion'] = 'Versión de la información';
$string['invalidredirecturl'] = 'Corolair devolvió un destino de redirección no confiable.';
...
$string['eventwebservicetokenlifecycle'] = 'Ciclo de vida del token de servicio web de Corolair actualizado';
...
$string['setupaction'] = 'Abrir la configuración de Corolair';
$string['setupchangeregistration'] = 'Se creará un token de servicio web de Moodle y se enviará a Corolair para registrar este sitio.';
...
$string['setupconfirmquestion'] = '¿Autoriza estos cambios globales y el inicio del registro de Corolair?';
$string['setupcontinuebutton'] = 'Iniciar el registro de Corolair';
$string['setupcontinuequestion'] = '¿Iniciar ahora el registro de Corolair?';
$string['setupconsentdescription'] = 'Corolair está inactivo actualmente. Al activarlo se realizarán los siguientes cambios globales:';
$string['setupconsentheading'] = 'Revisar y aprobar la activación de Corolair';
$string['setupconsentmissing'] = 'El registro de Corolair no puede ejecutarse sin el consentimiento registrado de un administrador.';
$string['setupcurrentstatus'] = 'Estado actual — Servicios web de Moodle: {$a->webservices}; REST: {$a->rest}.';
$string['setuppagetitle'] = 'Configuración de Corolair';
$string['setupqueued'] = 'Su consentimiento se registró y el registro de Corolair se añadió a la cola.';
$string['setupqueuedwithoutconsent'] = 'El registro de Corolair se añadió a la cola. No se modificó ninguna configuración global de servicios web.';
$string['setupreadynotification'] = 'Corolair se instaló. Los servicios web de Moodle y REST ya están habilitados. Un administrador debe <a href="{$a}">revisar la información de integración e iniciar el registro</a>.';
...
$string['setuprequirednotification'] = 'Corolair está instalado, pero permanece inactivo. Un administrador debe <a href="{$a}">revisar la información de integración y aprobar los cambios necesarios en los servicios web</a>.';
$string['setupstatus'] = 'Estado de la integración';
$string['setupstatuscomplete'] = 'Conectado. El consentimiento del administrador está registrado y el registro de Corolair ha finalizado.';
...
$string['tokenexpirywarningbody'] = 'Corolair no pudo rotar su token de servicio web de Moodle. El token actual caduca el {$a->expiry}. Código de error seguro: {$a->error}. Revise el cron y la conectividad en la configuración de Corolair.';
$string['tokenexpirywarningsubject'] = 'La rotación del token de Corolair requiere atención';
$string['tokenmissing'] = 'No se encontró el token de servicio web actual de Corolair.';
$string['tokenname'] = 'Token REST de Raison';
$string['tokenrotationrequestfailed'] = 'La solicitud de rotación del token de Corolair ha fallado.';
$string['tokenrotationresponseinvalid'] = 'Corolair devolvió una confirmación de rotación de token no válida.';
...
$string['tokenrotationretryqueued'] = 'El reintento de rotación del token de Corolair se añadió a la cola.';
...
$string['taskrotatewebservicetoken'] = 'Rotar el token de servicio web de Moodle de Corolair';
...
$string['viewrolescapability'] = 'Permite a los usuarios recuperar los roles de Moodle a través del servicio web de Corolair';
