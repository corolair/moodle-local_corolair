...
$string['cachedef_widgetcourses'] = 'Lista de cursos de Raison: los cursos de este sitio que tienen un asistente de Raison, actualizada cada cinco minutos.';
...
$string['disclosurecapexam'] = 'Permite que el flujo específico de colocación de exámenes cree, renombre y elimine la actividad Herramienta externa que contiene un examen de Raison. Es la única parte de la integración que escribe en un curso, y solo puede alcanzar las actividades creadas por Raison: el plugin registra cada colocación que realiza, y las funciones de renombrado y eliminación rechazan todo lo que no figure en ese registro. Una actividad Herramienta externa añadida por un docente, o perteneciente a otro producto, queda fuera de su alcance. La colocación se rechaza si la herramienta seleccionada no se lanza desde el host de Raison configurado.';
...
$string['hideonraisonexam'] = 'Ocultar el Tutor IA durante los exámenes de Raison';
$string['hideonraisonexamdesc'] = 'Raison ofrece una herramienta de exámenes con IA basada en LTI que quizá aún no esté configurada en su sitio: si desea conocerla mejor o probarla, póngase en contacto con el equipo de Raison en contact@raison.is. Cuando esta opción está activada, el Tutor IA no se muestra en las páginas que presentan una actividad de examen de Raison, de modo que los estudiantes no puedan pedirle ayuda mientras realizan una prueba. La actividad se reconoce porque la creó Raison o porque la herramienta externa que lanza utiliza el host indicado en «Host de la herramienta LTI de Raison» más abajo. Las demás actividades de Herramienta externa no se ven afectadas: para esas, utilice «Actividades excluidas» más arriba. Deje esta opción activada salvo que desee deliberadamente que el Tutor IA esté disponible durante los exámenes de Raison.';
...
$string['ltitoolhost'] = 'Host de la herramienta LTI de Raison';
$string['ltitoolhostdesc'] = 'El host desde el que se lanza la herramienta de exámenes de Raison. Raison ofrece una herramienta de exámenes con IA basada en LTI que quizá aún no esté configurada en su sitio: si desea conocerla mejor o probarla, póngase en contacto con el equipo de Raison en contact@raison.is. En caso contrario, no modifique este ajuste. Debe coincidir con la URL de la herramienta externa «Raison AI Exams», y Raison rechaza colocar un examen con cualquier herramienta que se lance desde otro host. Modifíquelo solo si el soporte de Raison se lo pide, por ejemplo tras un cambio de dirección del servicio. Un valor vacío o no válido vuelve al valor predeterminado incluido.';
$string['messageprovider:setuppending'] = 'Recordatorio de configuración de Raison';
$string['messageprovider:tokenexpirywarning'] = 'Aviso sobre el token de servicio web de Raison';
$string['missingcapability'] = 'No tiene permisos para acceder a esta página';
$string['noapikey'] = 'No hay clave API de Raison';
$string['placementnotowned'] = 'Esta actividad no fue creada por Raison, por lo que Raison no puede renombrarla ni eliminarla.';
$string['placementtoolnotallowed'] = 'Los exámenes solo pueden colocarse con la herramienta externa de Raison. La herramienta seleccionada se lanza desde «{$a->host}», pero este sitio solo acepta «{$a->allowed}». Consulte el ajuste «Host de la herramienta LTI de Raison».';
...
$string['privacy:metadata:raison:courseid'] = 'El identificador del curso que está viendo se envía para abrir el asistente de Raison de ese curso.';
$string['privacy:metadata:raison:currentpageurl'] = 'La dirección de la página del curso que está viendo se envía junto con su identidad cuando se carga en ella el asistente de Raison.';
...
$string['setuppendingbody'] = 'Raison está instalado en este sitio, pero ningún administrador ha iniciado su configuración, por lo que el sitio nunca se registró en Raison y ninguna función de Raison está disponible. Un administrador del sitio debe abrir {$a} para revisar la divulgación de la integración e iniciar el registro. Este es el resultado habitual de una instalación por línea de comandos: la invitación a abrir esa página solo se muestra durante la propia instalación, de modo que nadie la ve después. Moodle envía este recordatorio como máximo tres veces.';
$string['setuppendingsubject'] = 'Raison está instalado pero inactivo';
...
$string['setuprequiredtrainer'] = 'Raison aún no se ha configurado en este sitio. No se ha iniciado ningún registro con Raison, por lo que nada de esta página puede funcionar hasta que un administrador complete la configuración. Esto es lo que deja una instalación por línea de comandos: los archivos del plugin están en su sitio, pero la página de configuración nunca se abrió.';
$string['setuprequiredtrainernoaccess'] = 'Raison aún no se ha configurado en este sitio, por lo que no puede utilizarse. Solo un administrador del sitio puede completar la configuración: pídale que abra Administración del sitio > Plugins > Plugins locales > Raison y la finalice. Nada de esta página funcionará hasta entonces.';
...
$string['tasksendsetupreminder'] = 'Recordar a los administradores que la configuración de Raison no está terminada';
