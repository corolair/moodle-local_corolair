...
$string['customcss_desc'] = 'L\'apparence de l\'<a href="{$a->trainer_page_link}">espace Formateur</a> peut être affectée par votre thème Moodle ou certains réglages, ce qui peut entraîner des problèmes d\'affichage. Si vous constatez un souci de mise en page, vous pouvez ajouter votre propre CSS pour ajuster le rendu visuel. <strong>Utilisez cette option uniquement si nécessaire et si vous maîtrisez le CSS.</strong> Cliquez <a href="{$a->reset_css_link}">ici</a> pour rétablir les styles par défaut.';
