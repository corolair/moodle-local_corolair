...
$string['disclosurecaproleassign'] = 'Permet d’attribuer le rôle Manager Raison à un formateur invité depuis Corolair.';
...
$string['disclosuregrouproleassignmentdesc'] = 'Attribuer le rôle Manager Raison lorsqu’une invitation autorisée est initiée depuis Corolair.';
$string['disclosureheading'] = 'Examiner les informations sur l’intégration Corolair';
...
$string['disclosuretokentransfer'] = 'Le jeton est transféré à Corolair via HTTPS afin que l’intégration appelle les fonctions Moodle autorisées. Il expire après 15 jours et est renouvelé avant son expiration.';
...
$string['setupreadynotification'] = 'Corolair a été installé. Les services web Moodle et REST sont déjà activés. Un administrateur doit <a href="{$a}">examiner les informations sur l’intégration et démarrer l’enregistrement</a>.';
...
$string['setuprequirednotification'] = 'Corolair est installé mais reste inactif. Un administrateur doit <a href="{$a}">examiner les informations sur l’intégration et approuver les modifications requises des services web</a>.';
