...
$string['disclosurecapexam'] = 'Permet au flux spécifique de placement d’examen de créer, renommer et supprimer l’activité Outil externe qui porte un examen Raison. C’est la seule partie de l’intégration qui écrit dans un cours, et elle ne peut atteindre qu’une activité LTI : la fonction de suppression résout sa cible via la table LTI et ne peut donc supprimer aucun autre type d’activité.';
