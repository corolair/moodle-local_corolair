...
$string['ltitoolhostdesc'] = 'L’hôte depuis lequel l’outil d’examen Raison est lancé. Ne modifiez pas ce réglage. Il doit correspondre à l’URL de l’outil externe « Raison AI Exams », et Raison refuse de placer un examen avec un outil lancé depuis un autre hôte. Ne le modifiez que si l’assistance Raison vous le demande, par exemple après un changement d’adresse de service. Une valeur vide ou invalide revient à la valeur par défaut fournie.';
