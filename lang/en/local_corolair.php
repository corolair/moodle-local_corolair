...
$string['tokennotexist'] = 'A token for the Corolair REST service has not been generated. Click <a href="{$a->create_token_auto}">here</a> to create one automatically. If you prefer, you can generate it manually by following <a href="https://corolair.notion.site/Moodle-Integration-EN-5d5dc1e61f8d4bd89372a6b8009ec4e4?pvs=4" target="_blank">this guide</a>. Alternatively, you can submit a report to the Corolair support team <a href="{$a->skip_to_troubleshoot}">here</a>, and they will handle it for you.';
$string['apikeyset_success'] = 'The API key has been successfully set. Please reload the page to apply the changes.';
$string['createtoken_success'] = 'The token has been created successfully.';
$string['createtoken_error'] = 'An error occurred while creating the token. Please try again manually by following this <a href="https://corolair.notion.site/Moodle-Integration-EN-5d5dc1e61f8d4bd89372a6b8009ec4e4?pvs=4" target="_blank">step-by-step guide</a>.';
