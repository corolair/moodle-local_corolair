...
$string['disclosurecapexam'] = 'Allows the feature-specific exam-placement workflow to create, rename and delete the External tool activity that carries a Raison exam. This is the only part of the integration that writes to a course, and it can only reach an LTI activity: the deletion function resolves its target through the LTI table, so it cannot remove any other kind of course module.';
...
$string['disclosurefunctionsintro'] = 'The standardized plugin exposes the following 27 functions. Expand each group to review the exact names and read/write classification.';
