...
$string['disclosurecaproleassign'] = 'Allows a trainer invited from Corolair to be assigned the Raison Manager role.';
...
$string['disclosuregrouproleassignmentdesc'] = 'Assign the Raison Manager role when an authorized trainer invitation is initiated from Corolair.';
$string['disclosureheading'] = 'Review the Corolair integration disclosure';
...
$string['disclosuretokentransfer'] = 'The token is transferred to Corolair over HTTPS for the integration to call the allowlisted Moodle functions. It expires after 15 days and is rotated before expiry.';
...
$string['setupreadynotification'] = 'Corolair was installed. Moodle web services and REST are already enabled. A site administrator must <a href="{$a}">review the integration disclosure and start registration</a>.';
...
$string['setuprequirednotification'] = 'Corolair was installed but remains inactive. A site administrator must <a href="{$a}">review the integration disclosure and approve the required web-service changes</a>.';
