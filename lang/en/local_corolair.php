...
$string['deregisterfailed'] = 'Raison could not confirm that your organization was deregistered from the external service. Local plugin data has still been removed. Please contact the Raison support team to ensure any remaining data held by Raison is deleted.';
$string['legacycredentialmigrationadminmissing'] = 'The inherited Raison credentials cannot be replaced because no valid site administrator owns the integration.';
