...
$functions = [
    ...
    'local_corolair_assign_manager_role' => [
        'classname'    => 'local_corolair\\external\\assign_manager_role',
        'methodname'   => 'execute',
        'description'  => 'Assign the fixed Raison Manager role at system context.',
        'type'         => 'write',
        'capabilities' => 'local/corolair:assignmanagerrole',
    ],
    ...
    'local_corolair_delete_exam_placement' => [
        'classname'    => 'local_corolair\\external\\delete_exam_placement',
        'methodname'   => 'execute',
        'description'  => 'Delete a Raison LTI exam activity from a course.',
        'type'         => 'write',
        'capabilities' => 'moodle/course:manageactivities',
    ],
];
