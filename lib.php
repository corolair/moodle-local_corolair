...
function local_corolair_extend_navigation_course($navigation, $course, $context) {
    ...
    $url = "https://services.corolair.com/moodle-integration/courses/instances/tutor"; // TODO: Should be moved to settings and use get_string('apiendpoint', 'local_corolair')
